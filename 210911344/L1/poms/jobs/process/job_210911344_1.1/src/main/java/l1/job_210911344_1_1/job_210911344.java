...
/**
 * Job: job_210911344 Purpose: learn<br>
 ...
 * @status DEV
 */
public class job_210911344 implements TalendJob {
	...
	private final String jobName = "job_210911344";
	private final String projectName = "L1";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					job_210911344.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(job_210911344.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row8Struct implements routines.system.IPersistableRow<row8Struct> {
		final static byte[] commonByteArrayLock_L1_job_210911344 = new byte[0];
		static byte[] commonByteArray_L1_job_210911344 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_L1_job_210911344.length) {
					if (length < 1024 && commonByteArray_L1_job_210911344.length == 0) {
						commonByteArray_L1_job_210911344 = new byte[1024];
					} else {
						commonByteArray_L1_job_210911344 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_L1_job_210911344, 0, length);
				strReturn = new String(commonByteArray_L1_job_210911344, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_L1_job_210911344, 0, length);
				strReturn = new String(commonByteArray_L1_job_210911344, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_L1_job_210911344) {
	...
	public static class products_outStruct implements routines.system.IPersistableRow<products_outStruct> {
		final static byte[] commonByteArrayLock_L1_job_210911344 = new byte[0];
		static byte[] commonByteArray_L1_job_210911344 = new byte[0];
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "Product_id", "Product_name", "Sales_Rating", "Total_Expenditure",
						"Category", });
...
///////////////////////    			
				...
				fileName_tFileOutputDelimited_3 = (new java.io.File("D:/210911344/out1.1.csv")).getAbsolutePath()
						.replace("\\", "/");
				...
				util_tLogRow_2.addRow(new String[] { "Product_id", "Product_name", "Sales_Rating", "Total_Expenditure",
...
///////////////////////    			
				...
				fileName_tFileOutputDelimited_4 = (new java.io.File("D:/210911344/out1.2.csv")).getAbsolutePath()
						.replace("\\", "/");
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "products_out");
				}

				int tos_count_tFileOutputDelimited_1 = 0;

				String fileName_tFileOutputDelimited_1 = "";
				fileName_tFileOutputDelimited_1 = (new java.io.File("D:/210911344/out1.csv")).getAbsolutePath()
						.replace("\\", "/");
				...
				util_tLogRow_3
						.addRow(new String[] { "Product_id", "Product_name", "Sales_Rating", "Total_Expenditure", });
...
///////////////////////    			
				...
				fileName_tFileOutputDelimited_2 = (new java.io.File("D:/210911344/out2.csv")).getAbsolutePath()
						.replace("\\", "/");
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "D:/210911344/file1.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"D:/210911344/file1.csv", "ISO-8859-15", ",", "\n", true, 1, 0,
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"Sales_Rating", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
...
// # Output table : 'products_out'
									...
									products_out_tmp.Product_name = StringHandling.EREPLACE(row1.Product_name, "_",
											" ");
									products_out_tmp.Sales_Rating = row1.Sales_Rating;
									products_out_tmp.Total_Expenditure = row2.Total_Expenditure;
									products_out_tmp.Category = row1.Sales_Rating > 7 ? "Good" : "Bad";
...
// # Filter conditions 
								if (rejectedInnerJoin_tMap_1) {
									rejected_tmp.Product_id = row1.Product_id;
									rejected_tmp.Product_name = row1.Product_name;
									rejected_tmp.Sales_Rating = row1.Sales_Rating;
									rejected_tmp.Total_Expenditure = row2.Total_Expenditure;
...
// Start of branch "products_out"
							if (products_out != null) {
								...
								if (products_out.Product_id != null) {
									sb_tFileOutputDelimited_1.append(products_out.Product_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (products_out.Product_name != null) {
									sb_tFileOutputDelimited_1.append(products_out.Product_name);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (products_out.Sales_Rating != null) {
									sb_tFileOutputDelimited_1.append(products_out.Sales_Rating);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (products_out.Total_Expenditure != null) {
									sb_tFileOutputDelimited_1.append(products_out.Total_Expenditure);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (products_out.Category != null) {
									sb_tFileOutputDelimited_1.append(products_out.Category);
								}
								...
								ope_tFilterRow_1.matches(
										(row3.Category == null ? false : row3.Category.compareTo("Good") == 0),
										"Category.compareTo(\"Good\") == 0 failed");
								...
								if (ope_tFilterRow_1.getMatchFlag()) {
									...
									row4.Sales_Rating = row3.Sales_Rating;
									row4.Total_Expenditure = row3.Total_Expenditure;
									...
									row5.Product_id = row3.Product_id;
									row5.Product_name = row3.Product_name;
									row5.Sales_Rating = row3.Sales_Rating;
									row5.Total_Expenditure = row3.Total_Expenditure;
									row5.Category = row3.Category;
...
// Start of branch "row4"
								if (row4 != null) {
									...
									if (row4.Product_id != null) {
										sb_tFileOutputDelimited_3.append(row4.Product_id);
									}
									sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
									if (row4.Product_name != null) {
										sb_tFileOutputDelimited_3.append(row4.Product_name);
									}
									sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
									if (row4.Sales_Rating != null) {
										sb_tFileOutputDelimited_3.append(row4.Sales_Rating);
									}
									sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
									if (row4.Total_Expenditure != null) {
										sb_tFileOutputDelimited_3.append(row4.Total_Expenditure);
									}
									sb_tFileOutputDelimited_3.append(OUT_DELIM_tFileOutputDelimited_3);
									if (row4.Category != null) {
										sb_tFileOutputDelimited_3.append(row4.Category);
									}
...
///////////////////////		
									...
									if (row6.Product_id != null) { //
										row_tLogRow_1[0] = String.valueOf(row6.Product_id);

									} //

									if (row6.Product_name != null) { //
										row_tLogRow_1[1] = String.valueOf(row6.Product_name);

									} //

									if (row6.Sales_Rating != null) { //
										row_tLogRow_1[2] = String.valueOf(row6.Sales_Rating);

									} //

									if (row6.Total_Expenditure != null) { //
										row_tLogRow_1[3] = String.valueOf(row6.Total_Expenditure);

									} //

									if (row6.Category != null) { //
										row_tLogRow_1[4] = String.valueOf(row6.Category);
...
// Start of branch "row5"
								if (row5 != null) {
									...
									if (row5.Product_id != null) {
										sb_tFileOutputDelimited_4.append(row5.Product_id);
									}
									sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
									if (row5.Product_name != null) {
										sb_tFileOutputDelimited_4.append(row5.Product_name);
									}
									sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
									if (row5.Sales_Rating != null) {
										sb_tFileOutputDelimited_4.append(row5.Sales_Rating);
									}
									sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
									if (row5.Total_Expenditure != null) {
										sb_tFileOutputDelimited_4.append(row5.Total_Expenditure);
									}
									sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
									if (row5.Category != null) {
										sb_tFileOutputDelimited_4.append(row5.Category);
									}
									sb_tFileOutputDelimited_4.append(OUT_DELIM_tFileOutputDelimited_4);
									if (row5.errorMessage != null) {
										sb_tFileOutputDelimited_4.append(row5.errorMessage);
									}
...
///////////////////////		
									...
									if (row7.Product_id != null) { //
										row_tLogRow_2[0] = String.valueOf(row7.Product_id);

									} //

									if (row7.Product_name != null) { //
										row_tLogRow_2[1] = String.valueOf(row7.Product_name);

									} //

									if (row7.Sales_Rating != null) { //
										row_tLogRow_2[2] = String.valueOf(row7.Sales_Rating);

									} //

									if (row7.Total_Expenditure != null) { //
										row_tLogRow_2[3] = String.valueOf(row7.Total_Expenditure);

									} //

									if (row7.Category != null) { //
										row_tLogRow_2[4] = String.valueOf(row7.Category);

									} //

									if (row7.errorMessage != null) { //
										row_tLogRow_2[5] = String.valueOf(row7.errorMessage);
...
// Start of branch "rejected"
							if (rejected != null) {
								...
								if (rejected.Product_id != null) {
									sb_tFileOutputDelimited_2.append(rejected.Product_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rejected.Product_name != null) {
									sb_tFileOutputDelimited_2.append(rejected.Product_name);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rejected.Sales_Rating != null) {
									sb_tFileOutputDelimited_2.append(rejected.Sales_Rating);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rejected.Total_Expenditure != null) {
									sb_tFileOutputDelimited_2.append(rejected.Total_Expenditure);
								}
...
///////////////////////		
								...
								if (row8.Product_id != null) { //
									row_tLogRow_3[0] = String.valueOf(row8.Product_id);

								} //

								if (row8.Product_name != null) { //
									row_tLogRow_3[1] = String.valueOf(row8.Product_name);

								} //

								if (row8.Sales_Rating != null) { //
									row_tLogRow_3[2] = String.valueOf(row8.Sales_Rating);

								} //

								if (row8.Total_Expenditure != null) { //
									row_tLogRow_3[3] = String.valueOf(row8.Total_Expenditure);
...
///////////////////////    			
					...
					if (!((Object) ("D:/210911344/file1.csv") instanceof java.io.InputStream)) {
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "products_out");
				}
	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:()
				// linked node: tMap_1 - inputs:(row1,row2) outputs:(products_out,rejected)
				...
				try {
					...
					Object filename_tFileInputDelimited_2 = "D:/210911344/file2.csv";
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"Total_Expenditure", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
...
// Start of branch "row2"
					...
					if (!((Object) ("D:/210911344/file2.csv") instanceof java.io.InputStream)) {
	...
	public static void main(String[] args) {
		final job_210911344 job_210911344Class = new job_210911344();

		int exitCode = job_210911344Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = job_210911344.class.getClassLoader()
					.getResourceAsStream("l1/job_210911344_1_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = job_210911344.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : job_210911344");
		}
...
/************************************************************************************************
 * 201675 characters generated by Talend Open Studio for Data Integration on the
 * 1 February 2024 at 10:23:38 AM IST
 ************************************************************************************************/